...
## 关于使用hexo发布博客并同步到git上操作
## hexo deploy: hexo部署
## 添加新的文章或插件时，可以通过以下三个命令进行同步操作
  ## hexo clean
  ## hexo generate      
  ## hexo deploy
...
## hexo操作文档 https://hexo.io/zh-cn/docs/commands.html


# hexo主题安装流程
# 1. 去官网选择喜欢的主题：https://hexo.io/themes/
# 2. 打开主题的GitHub地址，安装到本地博客项目的根目录：git clone ....
